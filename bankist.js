...
const account5 = {
  ...
  pin: 1234,
  movementsDates: [
    "2024-10-02T10:17:24.185Z",
    "2024-10-07T10:17:24.185Z",
    "2024-10-08T10:17:24.185Z",
    "2024-10-09T10:17:24.185Z",
    "2024-10-14T10:17:24.185Z",
    "2024-10-15T10:17:24.185Z",
  ],
  currency: "MMK",
  locale: "my-MM",
};
...
const displayMovements = function (acc, sort = false) {
  ...
  const movs = sort
    ...
    : acc.movements; //regular sorting if it's false;
...
btnLoan.addEventListener("click", function (e) {
  e.preventDefault();
  const amount = Math.floor(Number(inputLoanAmount.value)); //math.floor = roundupnumbers
